  ...
  return (
    <header className="w-full py-4 px-6 shadow-lg">
        ...
        <h1
          ...
          <div className="flex items-baseline space-x-4 max-sm:justify-end max-sm:flex-1" style={{ zIndex: 1 }}>
          <FontAwesomeIcon
        ...
        >
          {/* Mobile Logo */}
          <h1 className="text-3xl text-transparent bg-gradient-to-r from-blue-500 
          ...
          {navItems.map(item => (
            ...
            via-purple-500 to-red-500 hover:text-black hover:font-bold cursor-pointer border-gray-600'
              onClick={() => handleModeSelection(item.text)}
            >
              {item.text}
            </li>
          ))}
